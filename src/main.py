...
class IllumioMonitoringTool:
    ...
    def _log_summary(self):
        ...
        self.logger.info(f"Illumio fetch: {self.execution_stats.get('illumio_fetch_time', 0):.2f}s")
        self.logger.info(f"ServiceNow fetch: {self.execution_stats.get('servicenow_fetch_time', 0):.2f}s")
        self.logger.info(f"Reconciliation: {self.execution_stats.get('reconciliation_time', 0):.2f}s")
        self.logger.info(f"Export generation: {self.execution_stats.get('export_time', 0):.2f}s")
        self.logger.info("-" * 40)
